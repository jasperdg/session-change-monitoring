 ...
 */
async function getRecentRates(limit = 500, timeRange = null, startTimeParam = null, endTimeParam = null) {
  const queryStart = Date.now();
  try {
    dbLog('info', 'Fetching recent rates', { limit, timeRange, startTimeParam, endTimeParam });
    let result;
